 ...
 * ModalForm class.
 */
class ParagraphCommentModalForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $options = NULL) {
    $form['#prefix'] = '<div id="modal_paragraph_comment_form">';
    $form['#suffix'] = '</div>';
   ...
   */
  public function submitParagraphCommentModalFormAjax(array $form, FormStateInterface $form_state) {
    $response = new AjaxResponse();

    // If there are any form errors, re-display the form.
    if ($form_state->hasAnyErrors()) {
      $response->addCommand(new ReplaceCommand('#modal_paragraph_comment_form', $form));
    }
    else {
  ...
  protected function getEditableConfigNames() {
    return ['config.modal_form_paragraph_comment_modal_form'];
  }
